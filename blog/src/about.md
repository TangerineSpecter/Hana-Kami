...
Hana-Kami is built on **Electron · React · TypeScript · Pixi.js · xterm.js · node-pty**, and it's **local-first** and **MIT-licensed**. Your agents run on your machine, on your Claude plan.

> Run an office of agents while you sleep.

Ready to start? [Download Hana-Kami]({{ site.origin }}/#install) or [star it on GitHub]({{ site.social.github }}).
