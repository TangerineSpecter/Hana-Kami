...
Hana-Kami ships this as the orchestrator's control surface — a live activity feed, per-agent token
and cost meters, a task board, and a memory graph for a whole
[hive of Claude Code agents](https://munderdiffl.in/#how), all local.
[Download Hana-Kami](https://munderdiffl.in/#install) to watch your fleet at a glance; it's free and
open source.
