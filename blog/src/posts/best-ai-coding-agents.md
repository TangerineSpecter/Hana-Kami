...
- **Multi-agent orchestration** — coordinate *several* agents as a team, with shared memory and a
  controller. (A local hive like Hana-Kami.)
...
[Cline vs Hana-Kami](/blog/cline-vs-munder-difflin/).)
...
[Hana-Kami](/#what) is built for: a local-first hive over the Claude Code sessions you already run.
...
[Claude Squad vs Hana-Kami](/blog/claude-squad-vs-munder-difflin/). Choosing between two terminal agents? [Codex CLI vs Claude Code](/blog/codex-cli-vs-claude-code/) compares them head to head.
...
Hana-Kami is the local **multi-agent orchestration** option in this field — a hive of Claude Code
agents on your own machine. [Download Hana-Kami](/#install) to coordinate a team; free and open
source.
