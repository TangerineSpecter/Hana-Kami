...
faq:
  ...
  - q: "Is Hana-Kami a multi-agent harness?"
...
- **Orchestration.** One coordinator turns your request into tasks and assigns them. In Hana-Kami that
...
Here is how [Hana-Kami](https://munderdiffl.in/) does it. Every agent is a real terminal CLI running
...
Hana-Kami is free and open source under the MIT license. [Download it](https://munderdiffl.in/) for
