...
```sh
codesign --verify --deep --strict --verbose=2 "dist/mac-universal/Hana-Kami.app"
spctl --assess --type execute --verbose "dist/mac-universal/Hana-Kami.app"   # → "accepted, source=Notarized Developer ID"
xcrun stapler validate "dist/mac-universal/Hana-Kami.app"
```
