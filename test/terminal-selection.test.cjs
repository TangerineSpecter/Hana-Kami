...
test('the reported paste: Claude Code blockquote rail is dropped', () => {
  assert.equal(
    sanitizeTerminalSelection('▎ Hana-Kami — clones for you and your team, working 24/7.'),
    'Hana-Kami — clones for you and your team, working 24/7.'
  );
});

test('every line of a multi-line quote loses its rail', () => {
  const copied = [
    '▎ Hana-Kami is live on Product Hunt today.',
    '▎',
